      ...
      <div className="flex flex-col gap-3 sm:flex-row md:gap-4">
        ...
        <div className="min-w-0 flex-1 sm:pl-6">
          <div className="mb-3 flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
            <h3 className="flex-1 text-base font-bold md:text-lg">
              {recruitment.title}
            </h3>
    ...
    <div className="min-h-screen bg-gray-50">
              ...
              {recommendedRecruitments.map((recruitment) => (
                ...
                >
                  <div className="relative w-full">
                    <div className="flex h-32 w-full items-center justify-center overflow-hidden rounded-t-lg bg-gray-100">
                      {recruitment.thumbnailType === 'image' ? (
                        <img
                          src={recruitment.thumbnail}
                          alt={recruitment.title}
                  ...
                  <div className="p-4">
                    <div className="mb-2 flex items-start justify-between gap-2">
                      <h3 className="line-clamp-2 min-h-12 flex-1 text-base font-bold">
                        {recruitment.title}
                      </h3>
      ...
      <div className="fixed right-6 bottom-6 z-50 flex flex-col gap-3">
        {showScrollTop && (
          <button
            onClick={scrollToTop}
            className="flex h-12 w-12 items-center justify-center rounded-full bg-gray-400 text-white shadow-lg transition-colors hover:bg-gray-500 md:h-14 md:w-14"
